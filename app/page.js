...
export default function HomePage() {
  ...
  const [imgErrors, setImgErrors] = useState(/** @type {{ [key: string]: boolean }} */ ({}));
  ...
  // ✅ FIX 2: Build timer entries with stable string keys
  const timerEntries = [
    { label: "h", value: pad(timeLeft.h) },
    { label: "m", value: pad(timeLeft.m) },
    { label: "s", value: pad(timeLeft.s) },
  ];
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh" }}>
        ...
        {/* Perks — ✅ FIX 1: key={title} now resolves correctly */}
        ...
        <div className="section-wrap">
          ...
          <div className="section-header">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              ...
              {/* ✅ FIX 2: key={entry.label} uses stable string, not array index */}
              {timerEntries.map((entry, i) => (
                <span key={entry.label} style={{ display: "flex", alignItems: "center" }}>
                  <span className="timer-unit">{entry.value}</span>
          ...
          {loading ? (
            ...
            <div className="products-grid">
              {products.map((product) => (
                // ✅ key={product.id} — uses stable Supabase row ID
                    ...
                    <div className="product-img-wrap">
                      {product.image_url && !imgErrors[product.id] ? (
                        ...
                        <span style={{ fontSize: "72px" }}>
                          {EMOJI_MAP[/** @type {keyof typeof EMOJI_MAP} */ (String(product.category))] || EMOJI_MAP.default}
                        </span>
                      )}
                    </div>
          ...
          <div className="reviews-section">
            ...
            <div className="reviews-grid">
              {[
                ...
                // ✅ key={name} — unique and stable for this static list
        ...
        {!isLoggedIn && (
          <div className="cta-section">
            <div className="cta-content">
              ...
              <p className="cta-sub">
                Join thousands of happy customers who have found their favourite jewelry at Novagem.
              </p>
